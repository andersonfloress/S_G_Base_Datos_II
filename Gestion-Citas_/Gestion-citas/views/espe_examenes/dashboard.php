...
<head>
    ...
    <title>Dashboard Especialista de Exámenes - Gestión de Citas</title>
...
<body>
    <div class="container-fluid">
        <div class="main-content">
            <h1 class="text-gradient">Panel de Especialista en Exámenes</h1>
            
            <div class="card dashboard-card mb-4">
                <div class="card-body">
                    <h4 class="text-primary">Bienvenido Dr(a). <?php echo htmlspecialchars($_SESSION['usuario_nombre']); ?></h4>
                    <p class="text-muted">Gestiona los exámenes y procedimientos médicos</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card dashboard-card h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Consulta las citas programadas para exámenes</p>
                            <div class="d-grid">
                                <a href="index.php?url=especial_examenes/verProximasCitas" class="btn btn-primary">Ver Citas</a>
                            </div>
                        </div>
                    </div>
                </div>
